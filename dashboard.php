									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql5 ="SELECT id from tbllostcars ";
...
?>
					...
					<div class="stat-panel-title text-uppercase">Lost Cars</div>
			</div>
		</div>
	<a href="lostcars.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
<div class="stat-panel-number h1 "><?php echo htmlentities($pid);?></div>
	<div class="stat-panel-title text-uppercase">Parking Reports</div>
			</div>
		</div>
